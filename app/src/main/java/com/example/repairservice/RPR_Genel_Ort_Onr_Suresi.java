...
public class RPR_Genel_Ort_Onr_Suresi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.titleTextView)).setText("Ortalama Süreye Ait Raporlar Sayfası");
        ...
        for(int i=0;i<onarimListesi.size();i++){
            toplamSure+=onarimListesi.get(i).getToplam_sure();

        }
        ((TextView)findViewById(R.id.GnlOrtOnrSureTextView)).setText("Toplam Onarım süresi (dk) : " + toplamSure);

        ((TextView)findViewById(R.id.GnlOrtOnrSureTextView2)).setText("Toplam Onarım Sayısı: " + onarimListesi.size());


        double ortalamaSure=toplamSure/onarimListesi.size();
        ...
        labels.add("Toplam Onarım Süresi ");
